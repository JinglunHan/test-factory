...
LastEditTime: 2024-01-02 19:23:45
FilePath: \my_tools\path-file.py
...
target_directory = '/workdir/data/fire/fire-dataset-dunnings/superpixels/original-full-images'  # 替换为你的目标路径
txt_file_path = '/workdir/data/fire/fire-dataset-dunnings/superpixels/dunning.txt'  # 替换为你想要保存文件路径的txt文件路径
